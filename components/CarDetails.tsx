    ...
    <Transition.Child
                ...
                leaveTo='opacity-0 scale-95'>
                    ...
                    max-h-[90vh] overflow-y-auto transform rounded-2xl
                     bg-white p-6 text-left shadow-xl transition flex flex-col gap-5">
<button 
type='button'
onClick={closeModal}
             ...
             fill priority
              className='object-contain'/>            
                    ...
                    <div className="flex gap-3">
                        ...
                        rounded-lg bg-primary-blue-100">
                        <Image 
...
<div className="flex-1 flex flex-col gap-2">
        ...
        <h2 className="font-semibold text-xl capitalize">
               ...
               {Object.entries(car).map(([key,value])=> (
                ...
                key={key}>
<h4 className='text-gray capitalize dark:text-black-100'> {key.split("_").join( "") || <Skeleton count={9} />}</h4>
<p className='text-black-100 font-semibold ' > {value || <Skeleton   count={9}/>}</p>
                </div>
               ))}
                </div>
</div>
